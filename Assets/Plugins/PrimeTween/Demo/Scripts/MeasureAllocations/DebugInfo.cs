...
namespace PrimeTweenDemo {
    ...
    ///     The first time a particular animation is played, C# runtime caches the delegate for this animation, and the
    ///     GC.Alloc is shown in Profiler.
...
#pragma warning restore 0414
        ...
        private static bool shouldDisable() {
            ...
            if (EditorApplication
                .isPaused) return false; // Profiler.enabled returns false if scene is started paused in Unity 2021.3.26
        ...
        private void Update() {
            ...
            if (newGCAlloc.HasValue && curGCAlloc != newGCAlloc.Value) {
                ...
                gcAllocText.text = $"Heap allocations: {EditorUtility.FormatBytes(newGCAlloc.Value)}";
            }
        }
#endif
    }
