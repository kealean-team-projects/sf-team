...
namespace PrimeTweenDemo {
    public class CameraController : Clickable {
        ...
        private void Update() {
            ...
            if (highlightedElementController?.current == null && InputController.GetDown() &&
                !EventSystem.current.IsPointerOverGameObject()) inputBeginPos = InputController.screenPosition;
            if (InputController.GetUp()) inputBeginPos = null;
