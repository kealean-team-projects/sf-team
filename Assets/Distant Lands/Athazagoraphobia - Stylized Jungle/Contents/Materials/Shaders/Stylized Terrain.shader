...
Shader "Distant Lands/Stylized Terrain"
{
    ...
    SubShader
    {
        ...
        void surf(Input i, inout SurfaceOutputStandard o)
        {
            ...
            float4 weightedBlend8_g59 = (weightedBlendVar8_g59.x * tex2D(_Normal0, uv_Splat0) + weightedBlendVar8_g59.y
                * tex2D(_Normal1, uv_Splat1) + weightedBlendVar8_g59.z * tex2D(_Normal2, uv_Splat2) +
                weightedBlendVar8_g59.w * tex2D(_Normal3, uv_Splat3));
            ...
            float4 lerpResult14_g60 = lerp(temp_output_2_0_g60, temp_output_38_0_g59,
                (break20_g60.g >= max(max(break20_g60.r, break20_g60.b), break20_g60.a) ? 1.0 : 0.0));
            ...
            float4 lerpResult8_g60 = lerp(lerpResult14_g60, temp_output_41_0_g59,
             (break20_g60.b >= max(max(break20_g60.r, break20_g60.g), break20_g60.a) ? 1.0 : 0.0));
            ...
            float4 lerpResult13_g60 = lerp(lerpResult8_g60, temp_output_44_0_g59,
                                     (break20_g60.a >= max(max(break20_g60.r, break20_g60.g), break20_g60.b)
                                    ? 1.0
                                    : 0.0));
            ...
            float4 lerpResult8 = lerp(_RockColor, localClipHoles100_g59,
                                      ((1.0 - ase_worldNormal.y) > _RockThreshold ? 0.0 : 1.0));
            o.Albedo = lerpResult8.xyz;
            float4 appendResult205_g59 = (float4(_Smoothness0, _Smoothness1, _Smoothness2, _Smoothness3));
            float4 appendResult206_g59 = (float4(tex2DNode4_g59.a, tex2DNode3_g59.a, tex2DNode6_g59.a,
                                                 tex2DNode7_g59.a));
