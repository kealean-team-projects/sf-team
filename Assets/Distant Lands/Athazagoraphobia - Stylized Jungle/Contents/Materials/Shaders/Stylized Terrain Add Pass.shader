...
Shader "Distant Lands/Stylized Terrain Add Pass"
{
    ...
    SubShader
    {
        Tags
        {
            "RenderType" = "TransparentCutout" "Queue" = "AlphaTest-99" "IgnoreProjector"="True"
        }
        Cull Back
        CGPROGRAM
        #pragma target 3.0
        ...
        void surf(Input i, inout SurfaceOutputStandard o)
        {
            ...
            float4 weightedBlend8_g69 = (weightedBlendVar8_g69.x * tex2D(_Normal0, uv_Splat0) + weightedBlendVar8_g69.y
                * tex2D(_Normal1, uv_Splat1) + weightedBlendVar8_g69.z * tex2D(_Normal2, uv_Splat2) +
                weightedBlendVar8_g69.w * tex2D(_Normal3, uv_Splat3));
            ...
            float4 lerpResult14_g70 = lerp(temp_output_2_0_g70, temp_output_38_0_g69,
                (break20_g70.g >= max(max(break20_g70.r, break20_g70.b), break20_g70.a) ? 1.0 : 0.0));
            ...
            float4 lerpResult8_g70 = lerp(lerpResult14_g70, temp_output_41_0_g69,
                      (break20_g70.b >= max(max(break20_g70.r, break20_g70.g), break20_g70.a) ? 1.0 : 0.0));
            ...
            float4 lerpResult13_g70 = lerp(lerpResult8_g70, temp_output_44_0_g69,
                                           (break20_g70.a >= max(max(break20_g70.r, break20_g70.g), break20_g70.b)
                                                ? 1.0
                                                : 0.0));
