...
Shader "Distant Lands/Stylized Fog"
{
    ...
    SubShader
    {
        ...
        Tags
        {
            "RenderType" = "HeightFog" "Queue" = "Transparent+1" "IgnoreProjector" = "True" "IsEmissive" = "true"
        }
        Cull Front
        ZWrite Off
        ZTest Always
        ...
        void surf(Input i, inout SurfaceOutput o)
        {
            ...
            float4 screenColor16 = UNITY_SAMPLE_SCREENSPACE_TEXTURE(_GrabTexture,
                              ase_grabScreenPos.xy/ase_grabScreenPos.w);
            ...
            float4 lerpResult41_g1 = lerp(saturate(lerpResult28_g1), _FogColor3,
                             saturate(((_ColorStart1 - temp_output_1_0_g1) / (_ColorStart1 - _ColorStart2))));
            float4 lerpResult35_g1 = lerp(lerpResult41_g1, _FogColor4,
                saturate(((_ColorStart2 - temp_output_1_0_g1) / (_ColorStart2 - _ColorStart3))));
            float4 lerpResult113_g1 = lerp(lerpResult35_g1, _FogColor5,
                                                    saturate(
                                                        ((_ColorStart3 - temp_output_1_0_g1) / (_ColorStart3 -
                                                            _ColorStart4))));
            ...
            float4 lerpResult97 = lerp(temp_output_81_0, float4(hsvTorgb110, 0.0),
                                       saturate((LightMask95 * (1.5 * temp_output_52_0))));
            float4 lerpResult17 = lerp(screenColor16, lerpResult97, temp_output_52_0);
            o.Emission = lerpResult17.rgb;
            float3 ase_vertex3Pos = mul(unity_WorldToObject, float4(i.worldPos, 1));
            o.Alpha = saturate(
                ((1.0 - saturate(((ase_vertex3Pos.y * (1.0 / _FogSmoothness)) + (1.0 - _FogOffset)))) * _FogIntensity));
        }
        ENDCG
    }
}
